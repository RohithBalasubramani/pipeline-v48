"""services/dict_merge.py — the pure recursive deep-merge helper for the layer2 pipeline process.
...
This is the layer2-process twin of ems_backend/lt_panels/services/dict_merge.py: SAME pure function, but importable
WITHOUT the Django/psycopg ems_backend package chain (that package's __init__ eagerly imports a DB connection module).
