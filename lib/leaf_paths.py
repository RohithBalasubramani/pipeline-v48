"""lib/leaf_paths.py — THE ONE dotted-path address home (dotted + indexed: a.b[0].c / a.b.0.c).
...
Home moved from ems_exec/executor/paths.py (sys.modules-alias facade kept there) — grounding/validate/layer1b consume
