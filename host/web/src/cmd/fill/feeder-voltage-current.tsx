...
// one file per card + shared helpers (frame-view-model / payload-unwrap / date-wiring / types).
// This barrel keeps the ./fill/*.tsx glob match and re-exports the CARDS registry unchanged.
