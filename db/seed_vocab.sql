...
INSERT INTO app_config (key, value, data_type, section, note) VALUES
 ...
 ('vocab.element_chrome_keys',
  '["decimals","width","dash","warn","trip","index","span","order","separator","from","to","legendvalue","stroke","opacity","radius","zindex","z"]',
  'json', 'vocab',
  'per-element object keys that hold DESIGN CHROME even though they are numeric (line width/dash, decimals, warn/trip thresholds, positional index, zone from/to bounds) — the series-of-objects expander DENYLIST: a numeric element key here is NEVER a fillable data leaf, so the whole series stays chrome. Lower-cased match.'),
