...
--   equipment.kitpreview.media_base — BY CONTRACT a LOCAL filesystem directory: the dir the web origin serves as
...
INSERT INTO app_config (key, value, data_type, section, note) VALUES
  ...
  ('equipment.kitpreview.media_base', '', 'text', 'equipment',
   'LOCAL filesystem directory (BY CONTRACT — never a URL) holding the kit-preview GLBs; the same dir the web origin serves as /media/. Empty/unreadable/remote -> DEFAULT-DENY: no 3D url ever ships (gap cause glb_not_in_media_root).')
