...
SYSTEM = (
    ...
    "window, a phase/scope, or a close variation. Most suggestions should LITERALLY START WITH the "
    "user's typed text. Do NOT switch to a different intent, a different metric family, or an unrelated "
    "question.\n"
